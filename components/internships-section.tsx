          ...
          <div className="space-y-12">
            {internships.map((internship, index) => (
              ...
              >
                ...
                {/* Horizontal line connecting timeline to card - extends all the way to card */}
                <div
                  className={`absolute top-1/2 h-0.5 bg-gray-300 dark:bg-gray-600 hidden md:block ${
                    index % 2 === 0
                      ? "right-1/2 w-1/2 transform -translate-x-2" // For left-side cards, line spans from center to left edge
                      : "left-1/2 w-1/2 transform translate-x-2" // For right-side cards, line spans from center to right edge
                  }`}
                ></div>
